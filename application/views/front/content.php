        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="text-center mb-4 pb-1">
                    ...
                    <p class="text-muted">Tanggal penting jadwal pendaftaran dan penutupan Kartu Indonesia Pintar Kuliah Tahun 2020
                    </p>
...
<section class="section bg-light" id="berita">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="title text-center mb-3">
                    ...
                    <p class="text-muted">Lihat berita dan pengumuman terbaru dari KIPK.
                    </p>
                </div>
            </div>
        </div>
        ...
        <h4 class="mb-3">
            ...
            </i> Pendaftaran KIP-Kuliah Jalur SNMPTN
        </h4>
    </a>
    ...
    <a data-toggle="modal" id="getInformasi" data-target="#viewInformasi" data-url="informasi/23" href="#.">
        <h4 class="mb-3">
            <i class="mdi mdi-album">
            </i> Prosedur Pendaftaran KIP Kuliah
        </h4>
    </a>
    ...
    <a data-toggle="modal" id="getInformasi" data-target="#viewInformasi" data-url="informasi/22" href="#.">
        <h4 class="mb-3">
            <i class="mdi mdi-album">
            </i> Syarat Pendaftaran KIP Kuliah
        </h4>
    </a>
